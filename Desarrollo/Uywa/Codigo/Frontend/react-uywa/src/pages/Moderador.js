    ...
    return (
        <div className="Menu">
            <Container  sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom:"15vh"}}>
                <Box className="moderador-container-image">
                    <CardMedia
                        component="img"
                        alt="InnovaTech"
                        height="600"
                        image="https://source.unsplash.com/random?wallpapers"
                        className="moderador-image"
                    />
                    <Typography variant="h1" className="moderador-title">
                        Bienvenido Moderador
                    </Typography>
                </Box>
                <Card sx={{textAlign:'center', backgroundColor:"#D3D3D3", width:"80vw", margin:"5%"}}>
                    <Typography variant="h4" sx={{textAlign:'center', padding:3, fontSize:"clamp(0.8rem, 2vw, 2rem)"}}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </Typography>
                </Card>
                <Box className="moderador-charter-box">
